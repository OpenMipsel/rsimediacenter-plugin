...
class SeekInput(Screen):
		...
		<screen position="10,10" size="200,60" title="Seekinput" flags="wfNoBorder">
			...
			<widget name="hourspixmap" transparent="1" position="21,18" zPosition="2" size="45,36" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/skins/default/images/timeseek_sel.png" alphatest="on" />
			<widget name="minutespixmap" transparent="1" position="77,18" zPosition="2" size="45,36" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/skins/default/images/timeseek_sel.png" alphatest="on" />
